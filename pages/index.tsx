      ...
      <div className='max-md:w-10/12 md:w-5/12 px-10 pb-8 bg-white shadow-md rounded-md'>
        <div className='w-full flex flex-col items-center pt-4 space-y-6'>
          <div className='w-full flex justify-around pt-4'>
            <div className='border w-2/4 border-pink-650 rounded-l-lg py-4 px-10 text-white bg-pink-650'>Login</div>
            <div className='border w-2/4 border-gray-300 rounded-r-lg py-4 px-10 text-gray-400'>Signup</div>
          </div>
